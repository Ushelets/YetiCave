...
if ($is_auth) {
    ?>
                <div class="user-menu_image">
                    <img src="/img/user.jpg" width="80" height="80" alt="Пользователь"
                </div>
    ...
    ?>
                <li class="lots__item lot">
                    ...
                    <div class="lot__info">
                        ...
                        <h3 class="lot__title">
                            <a class="text-link" href="/pages/lot.html"><?=$value['name']?></a>
                        </h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=MoneyRus($value['price'])?><b class="rub">р</b></span>
                            </div>
